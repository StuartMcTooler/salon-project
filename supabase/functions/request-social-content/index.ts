          ...
          messages: [
            {
              role: "user",
              content: [
                { type: "text", text: "Lightly enhance this image for social media - improve colors, contrast, and sharpness while keeping it natural. DO NOT rotate or change the orientation." },
