      ...
      >
        ...
        {appointments?.map((appointment) => {
          ...
          return (
            <div
              key={appointment.id}
              className={`${getStatusColor(appointment.status || 'pending')} text-white p-2 rounded cursor-pointer hover:opacity-90 transition-opacity border-l-4 border-white/50 shadow-sm overflow-hidden`}
              style={{
